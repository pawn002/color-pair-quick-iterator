    ...
    return html`
      ...
      <main class="app-container" id="main-content">
        <div class="primary-stack">
          <candor-card class="title-and-sliders" variant="elevated" padding="none">
            ...
            <div class="title-and-sliders__body">
              <candor-accordion-item title="How to use this app." variant="quiet">
                <p>
                ...
                <candor-button variant="secondary" size="small" @clicked=${() => (this.activeNoteModal = 'accessibility')}>
              ...
              <candor-accordion-item title="Foreground LCH Limits" variant="subtle">
              ...
              <candor-accordion-item title="Background LCH Limits" variant="subtle">
                <div class="pallette-viz-content">
                  <cc-palette-table
                    color=${this.bgColor}
          ...
          <candor-card class="quick-actions" variant="elevated" padding="sm">
            <div class="quick-actions__buttons">
              ...
              <candor-tooltip text="Match chromas">
                <candor-button variant="tertiary" size="icon" aria-label="Harmonize Color Pair To Same Chroma" @clicked=${this._matchChromas}>
              ...
              <candor-tooltip text="Reset sliders">
                <candor-button variant="tertiary" size="icon" aria-label="Reset Color Sliders" @clicked=${this._resetSliders}>
                  <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              ...
              <candor-tooltip text="New random pair">
                <candor-button variant="tertiary" size="icon" aria-label="Create Random Color Pair" @clicked=${() => this._setRandomColorPair()}>
          ...
          <candor-card class="options" variant="elevated" padding="md">
            ...
            <candor-accordion-item title="Change how Colors Contrast works.">
              <div>
                    ...
                    return html`
                      <div class="radio-item">
                        ...
                        <candor-tooltip text=${aboutLabels[type]} position="left">
                          <candor-button variant="ghost" size="icon" aria-label=${aboutLabels[type]} @clicked=${() => (this.activeNoteModal = type)}>
                            ${this._INFO_SVG}
                          </candor-button>
                        </candor-tooltip>
                      </div>
                ...
                <div class="checkbox-section">
                  <div class="checkbox-item">
                    ...
                    <candor-tooltip text="About Constant chroma" position="left">
                      <candor-button variant="ghost" size="icon" aria-label="About Constant chroma" @clicked=${() => (this.activeNoteModal = 'constantChroma')}>
                        ${this._INFO_SVG}
                      </candor-button>
                    </candor-tooltip>
                  </div>
                  <div class="checkbox-item">
                    ...
                    <candor-tooltip text="About Show Gradient" position="left">
                      <candor-button variant="ghost" size="icon" aria-label="About Show Gradient" @clicked=${() => (this.activeNoteModal = 'showGradient')}>
                        ${this._INFO_SVG}
                      </candor-button>
                    </candor-tooltip>
                  </div>
        ...
        <candor-card class="metadata" variant="elevated" padding="md">
          ...
          <candor-accordion-item title="Descriptive data about your inputted colors." ?open=${true}>
            <cc-metadata
              colorone=${this.fgComparedColor}
              colortwo=${this.bgComparedColor}
